## Hey there 👋
Welcome to my GitHub profile! I'm **Anurag Padhiyar**, currently working as a **Database Administration**.  

I'm passionate about learning new things and exploring various technologies. 
I have a particular love for coding in Python, Database Administration (MSSQL & PostgreSQL), Advanced SQL concepts, and developing exciting projects.
...
- 🔭 I’m currently working on:
  - Advanced SQL concepts and real-world Database Administration tasks (MSSQL & PostgreSQL)
  ...
  - **News Aggregator Application**: Leading a team to develop a multilingual news aggregator platform.
  - **React Projects**: Building dynamic and interactive web applications using React.
- 🌱 I’m currently learning:
  - Advanced SQL & Database Administration (MSSQL & PostgreSQL)
  - **Game Development**: Diving deeper into game mechanics, AI, and rendering techniques.
  - **JavaScript and React**: Enhancing my front-end development skills using pure JavaScript (Vanilla JS) and React.
...
- 🎮 Hobbies:
  - **Playing Video Games like Apex Legends:** Enjoying immersive gaming experiences and engaging in fast-paced combat, strategic teamwork, and dynamic gameplay.
  - **Exploring Game Mechanics:** Fascinated by understanding the inner workings of games, including rules, interactions, systems, and design principles.
...
### Career Objective
I am currently working as  Database Administration, focusing on MSSQL, PostgreSQL, and Advanced SQL concepts. I also have a strong foundation in Python, web development, and game development using Pygame. My goal is to continuously learn, explore new technologies, and contribute effectively to real-world projects.
...
#### [News Aggregator Application](https://github.com/HotShot003/News-Aggregator)
...
[![Personal-Portfolio-Website](https://img.shields.io/badge/Portfolio%20-%23121011.svg?&style=for-the-badge&logo=github&logoColor=white)](https://anuragpadhiyar-portfolio-website03.netlify.app/)
